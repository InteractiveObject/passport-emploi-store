...
function Strategy(options, verify) {
    ...
    // production authorizationURL:  https://authentification-candidat-tis.pe-qvr.fr
    // production tokenURL: https://authentification-candidat-tis.pe-qvr.fr

    // test authorizationURL: https://authentification-candidat-r.pe-qvr.fr
    // test tokenURL: https://authentification-candidat-r.pe-qvr.fr

    options.authorizationURL = options.authorizationURL || 'https://authentification-candidat-tis.pe-qvr.fr/connexion/oauth2/authorize' + '?' + "realm=" + options.realm +  "&response_type=" + options.responseType + "&nonce=" + options.nonce; 
    options.tokenURL = options.tokenURL || 'https://authentification-candidat-tis.pe-qvr.fr/connexion/oauth2/access_token' + '?realm=' + options.realm ;
    ...
    //test _userProfileURI:  https://api-r.es-qvr.fr/connexion/userinfo/partenaire/peconnect-individu/v1/userinfo
    //production _userProfileURI:https://authentification-candidat-tis.pe-qvr.fr/connexion/userinfo' + '?' + options.realm;

    this._userProfileURI = 'https://authentification-candidat-tis.pe-qvr.fr/connexion/userinfo' + '?' + options.realm;
}
