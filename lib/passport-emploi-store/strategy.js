...
function Strategy(options, verify) {
    ...
    options.authorizationURL = options.authorizationURL || 'https://authentification-candidat-tis.pe-qvr.fr/connexion/oauth2/authorize' + '?' + options.realm;
    options.tokenURL = options.tokenURL || 'https://authentification-candidat-tis.pe-qvr.fr/connexion/oauth2/access_token' + '?' + options.realm;
