 ...
 *
 * Options:
 *   - `clientID`      your EmploiStore application's client id
 *   - `clientSecret`  your EmploiStore application's client secret
 *   - `callbackURL`   URL to which EmploiStore will redirect the user after granting authorization
 *
 * Examples 1:
 *     var EmploiStoreStrategy = require('passport-emploi-store').Strategy;
 *     var cfStrategy = new EmploiStoreStrategy({
 *         clientID: '123-456-789',
 *         clientSecret: 'shhh-its-a-secret'
 *         callbackURL: 'https://myapp.com/auth/emploi-store/callback'
 *       },
 ...
 *     var cfStrategy = new EmploiStoreStrategy({
 *         clientID: '123-456-789',
 *         clientSecret: 'shhhut-its-a-secret',
 *         callbackURL: 'https://myapp.com/auth/emploi-store/callback',
...
function Strategy(options, verify) {
    ...
    options.tokenURL = options.tokenURL || 'shttps://authentification-candidat.pole-emploi.fr/connexion/oauth2/access_token';
 ...
 *
 * This function calls /info endpoint of EmploiStore and returns the result
 * as 'profile'
 *
 ...
 * Default value: https://api.emploi-store.fr/partenaire/peconnect-individu/v1/userinfo
 *
